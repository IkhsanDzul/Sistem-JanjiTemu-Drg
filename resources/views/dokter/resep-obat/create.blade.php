...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form action="{{ route('dokter.resep-obat.store-master') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <select id="satuan" 
                    ...
                    <option value="mg" {{ old('satuan') == 'mg' ? 'selected' : '' }}>mg (Miligram)</option>
            ...
            <div>
                ...
                <textarea id="aturan_pakai_default" 
                          ...
                          placeholder="Contoh: 3x1 sehari setelah makan">{{ old('aturan_pakai_default') }}</textarea>
            ...
            <div>
                ...
                <textarea id="deskripsi" 
                          ...
                          placeholder="Deskripsi singkat tentang obat (opsional)">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
