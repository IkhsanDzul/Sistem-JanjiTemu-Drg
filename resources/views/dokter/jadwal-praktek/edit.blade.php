...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-gradient-to-r from-[#005248] to-[#007a6a] rounded-lg shadow-md p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-semibold">Edit Jadwal Praktek</h2>
                <p class="text-sm text-white/90 mt-1">Ubah informasi jadwal praktek Anda</p>
            </div>
    ...
    <!-- Form Section -->
    <form action="{{ route('dokter.jadwal-praktek.update', $jadwal->id) }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 space-y-6">
        @csrf
        @method('PUT')
