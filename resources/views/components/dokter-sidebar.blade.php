...
<aside x-data="{ open: false }" 
    ...
    <nav class="flex-1 overflow-y-auto py-4">
        <ul class="space-y-1 px-3">
            ...
            <!-- Resep Obat -->
            <li>
                <a href="{{ route('dokter.resepobat') }}" 
                   class="flex items-center px-4 py-3 text-white rounded-lg hover:bg-[#005248]/80 transition-colors {{ request()->routeIs('dokter.resepobat') ? 'bg-[#FFA700] text-white' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
