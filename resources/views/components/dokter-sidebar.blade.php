            ...
            <ul class="space-y-1 px-3">
                ...
                <li>
                    <a href="{{ route('dokter.dashboard') }}"
                        class="flex items-center px-4 py-3 text-white rounded-lg hover:bg-[#005248]/80 transition-colors {{ request()->routeIs('dokter.dashboard') ? 'bg-[#FFA700] text-white' : '' }}">
                ...
                <li>
                    <a href="{{ route('dokter.janji-temu.index') }}"
                        class="flex items-center px-4 py-3 text-white rounded-lg hover:bg-[#005248]/80 transition-colors {{ request()->routeIs('dokter.janji-temu.index') ? 'bg-[#FFA700]' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('dokter.rekam-medis') }}"
                        class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('dokter.rekam-medis') ? 'bg-[#FFA700] text-white' : 'text-gray-200 hover:bg-[#004039]' }} transition-colors">
                ...
                <li>
                    <a href="{{ route('dokter.tambah-obat.index') }}"
                        class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('dokter.tambah-obat.index') ? 'bg-[#FFA700] text-white' : 'text-gray-200 hover:bg-[#004039]' }} transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="{{ route('dokter.resep-obat.index') }}"
                        class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('dokter.resep-obat.index') ? 'bg-[#FFA700] text-white' : 'text-gray-200 hover:bg-[#004039]' }} transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
