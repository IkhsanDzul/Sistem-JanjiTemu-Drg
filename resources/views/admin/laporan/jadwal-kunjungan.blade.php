    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Tanggal: {{ $tanggalLaporan }}</p>
            </div>
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.laporan.jadwal-kunjungan', ['format' => 'pdf', 'tanggal' => $tanggal]) }}" 
                ...
                <a href="{{ route('admin.laporan.jadwal-kunjungan', ['format' => 'excel', 'tanggal' => $tanggal]) }}" 
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">Tidak ada jadwal kunjungan untuk tanggal ini</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
