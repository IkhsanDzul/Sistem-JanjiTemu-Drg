...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Edit Pasien</h2>
            <p class="text-sm text-gray-600 mt-1">Perbarui informasi pasien</p>
        </div>
    ...
    <!-- Form Section -->
    <form action="{{ route('admin.pasien.update', $pasien->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md border border-gray-100 p-6 space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="nama_lengkap" 
                           name="nama_lengkap" 
                           value="{{ old('nama_lengkap', $pasien->user->nama_lengkap) }}"
                           required
                ...
                <div>
                    ...
                    <input type="date" 
                           id="tanggal_lahir" 
                           name="tanggal_lahir" 
                           value="{{ old('tanggal_lahir', $pasien->user->tanggal_lahir) }}"
                           required
                ...
                <div>
                    ...
                    <input type="text" 
                           id="nomor_telp" 
                           name="nomor_telp" 
                           value="{{ old('nomor_telp', $pasien->user->nomor_telp) }}"
                           required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="alamat" 
                              ...
                              placeholder="Masukkan alamat lengkap">{{ old('alamat', $pasien->user->alamat) }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="riwayat_penyakit" 
                              ...
                              placeholder="Masukkan riwayat penyakit jika ada">{{ old('riwayat_penyakit', $pasien->riwayat_penyakit) }}</textarea>
