...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Edit Dokter</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="nama_lengkap" 
                           name="nama_lengkap" 
                           value="{{ old('nama_lengkap', $dokter->user->nama_lengkap) }}"
                           required
 ...
 -->
                ...
                <div>
                    ...
                    <input type="date" 
                           id="tanggal_lahir" 
                           name="tanggal_lahir" 
                           value="{{ old('tanggal_lahir', $dokter->user->tanggal_lahir) }}"
                           required
                ...
                <div>
                    ...
                    <input type="text" 
                           id="nomor_telp" 
                           name="nomor_telp" 
                           value="{{ old('nomor_telp', $dokter->user->nomor_telp) }}"
                           required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="alamat" 
                              ...
                              placeholder="Masukkan alamat lengkap">{{ old('alamat', $dokter->user->alamat) }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('spesialisasi_gigi', $dokter->spesialisasi_gigi) }}"
                           required
