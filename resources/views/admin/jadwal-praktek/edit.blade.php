...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Edit Jadwal Praktek</h2>
            <p class="text-sm text-gray-600 mt-1">
                Edit jadwal praktek untuk <span class="font-semibold">{{ $dokter->user->nama_lengkap ?? 'N/A' }}</span>
            </p>
        </div>
    ...
    <!-- Form Section -->
    <form action="{{ route('admin.dokter.jadwal-praktek.update', [$dokter->id, $jadwal->id]) }}" method="POST" class="bg-white rounded-lg shadow-md border border-gray-100 p-6 space-y-6">
        @csrf
        @method('PUT')
